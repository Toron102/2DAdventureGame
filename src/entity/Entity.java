...
public class Entity {
	...
	public void checkCollision() {
		...
		if(this.type == type_monster && contactPlayer == true) {
			if(gp.player.invincible == false && (this.dying != true || this.alive != true )) {
	...
	public void checkShootOrNot(int rate, int shotInterval) {
		...
		int i = new Random().nextInt(rate);
		if(i  == 0 && projectile.alive != true & shotAvailableCounter == shotInterval) {
...
//			gp.projectileList.add(projectile);
	...
	public String getOppositeDirection(String direction) {
		...
		switch(direction) {
		case "up": opositeDirection = "down"; break;
		case "down": opositeDirection = "up"; break;
		case "left": opositeDirection = "right"; break;
		case "right": opositeDirection = "left"; break;
		}
		...
		if(gp.player.invincible == false) {
			...
			if(gp.player.guarding == true && gp.player.direction.equals(canGuardDirection)) {
				...
				if(gp.player.guardCounter < 10) {
					damage = 0;
					gp.playSE(16);
					setKnockBack(this, gp.player, gp.player.knockBackPower/2);
					offBalance = true;
					spriteCounter =- 60;
				}
				//Normal guard
...
//			int nexCol = gp.pFinder.pathList.get(0).col;
//			int nextRow = gp.pFinder.pathList.get(0).row;
//			if(nexCol == goalCol && nextRow == goalRow) {
//				onPath = false;
//			}
		}
	}
	...
	public int getDetected(Entity user, Entity target[][], String targetName) {
		...
		case "up": nextWorldX = user.getTopY()-1; break;
		case "down": nextWorldY = user.getBotY()+1; break;
